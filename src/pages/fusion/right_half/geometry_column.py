...
class GeometryColumn(QWidget):
    ...
    def _build_prepare_centerline_group(self) -> QGroupBox:
        ...
        self._pc_spacing_mm.setValue(0.5)
        ...
        self._pc_smooth_sigma.setValue(1.5)
    ...
    def _build_label_geometry_group(self) -> QGroupBox:
        ...
        self._bounding_sphere_radius_rca.setValue(3.5)
        ...
        self._bounding_sphere_radius_lca.setValue(3.5)
        ...
        self._step_size_labeling.setValue(0.5)
        ...
        self._range_mm_takeoff_rca.setValue(45.0)
        ...
        self._range_mm_takeoff_lca.setValue(45.0)
