...
HolOrama detects that respiratory component from the lumen-area signal, lets you review and
correct it, and can then **reorder the gated frames into a breathing-corrected pullback**.
